...
| :--- | :--- | :--- |
| **Dataset & Report** | Google Drive folder containing the CSV dataset, PDF Report, and Slides. | [PASTE GOOGLE DRIVE LINK HERE] |
| **Demo Video** | YouTube video demonstrating the Streamlit App in action. | [PASTE YOUTUBE DEMO LINK HERE] |
| **Presentation** | Recorded video presentation of the project slides. | [PASTE PRESENTATION VIDEO LINK HERE] |
| **Final Report** | PDF detailed report of methodology and results. | [See report.pdf](./report.pdf) |
